...
<div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    <h1 class="text-4xl font-bold mb-6 text-indigo-600" data-aos="fade-up">Edit Article</h1>
    ...
    <div class="bg-white p-6 rounded-lg shadow hover-rise" data-aos="fade-up" data-aos-delay="100">
        <div class="border-l-4 border-indigo-400 pl-4 mb-6">
            <h2 class="text-xl font-semibold text-indigo-700">Update Article</h2>
        </div>
        ...
        <form method="POST" action="{{ route('admin.articles.update', $article) }}" enctype="multipart/form-data">
            ...
            <div class="mb-6" data-aos="fade-up" data-aos-delay="150">
                ...
                <div class="relative">
                    ...
                    <input id="title" name="title" value="{{ old('title', $article->title) }}" class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg input-dynamic-border focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition" placeholder="Enter title" required>
                    @error('title')
            ...
            <div class="mb-6" data-aos="fade-up" data-aos-delay="300">
                ...
                <div class="relative">
                    ...
                    <input id="hashtags" name="hashtags" value="{{ old('hashtags', implode(',', $article->hashtags ?? [])) }}" class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg input-dynamic-border focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition" placeholder="Enter hashtags">
                    @error('hashtags')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="mb-6" data-aos="fade-up" data-aos-delay="350">
                ...
                @if ($article->thumbnail)
                    <div class="mt-4">
                        <img src="{{ asset('storage/' . $article->thumbnail) }}" class="w-32 h-auto rounded shadow-md" alt="Current Thumbnail">
                    </div>
                @endif
            </div>
            ...
            <div class="mb-6" data-aos="fade-up" data-aos-delay="400">
                ...
                <div class="relative">
                    ...
                    <textarea id="body" name="body" rows="8" class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg input-dynamic-border focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition" placeholder="Enter article body" required>{{ old('body', $article->body) }}</textarea>
                    @error('body')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="flex gap-3" data-aos="fade-up" data-aos-delay="450">
                ...
                <button type="submit" class="inline-flex items-center bg-indigo-600 text-white px-6 py-3 rounded-lg hover:bg-indigo-700 transition-colors" dusk="submit-article"> 
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
