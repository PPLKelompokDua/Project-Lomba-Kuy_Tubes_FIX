...
<div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    <h1 class="text-4xl font-bold mb-6 text-indigo-600" data-aos="fade-up">Add New Learning Video</h1>
    ...
    <div class="bg-white p-6 rounded-lg shadow hover-rise" data-aos="fade-up" data-aos-delay="100">
        <div class="border-l-4 border-indigo-400 pl-4 mb-6">
            <h2 class="text-xl font-semibold text-indigo-700">Create New Learning Video</h2>
        </div>
        ...
        <form action="{{ route('admin.learning-videos.store') }}" method="POST" class="p-6">
            ...
            <div class="mb-6" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="title" id="title" value="{{ old('title') }}" class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg input-dynamic-border focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition" placeholder="Enter title" required>
                    @error('title')
            ...
            <div class="mb-6" data-aos="fade-up" data-aos-delay="250">
                ...
                <div class="relative">
                    ...
                    <textarea name="description" id="description" rows="4" class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg input-dynamic-border focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition" placeholder="Enter description">{{ old('description') }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6" data-aos="fade-up" data-aos-delay="300">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="url" name="thumbnail_url" id="thumbnail_url" value="{{ old('thumbnail_url') }}" placeholder="https://example.com/image.jpg" class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg input-dynamic-border focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6" data-aos="fade-up" data-aos-delay="350">
                <div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="duration" id="duration" value="{{ old('duration') }}" placeholder="5:30" class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg input-dynamic-border focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition">
