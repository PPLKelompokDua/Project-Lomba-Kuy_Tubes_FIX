...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
  ...
  <div class="mb-6 flex justify-end">
    <a href="{{ route('competitions.create') }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition ease-in-out duration-150">
                  ...
                  <div class="flex space-x-2">
                    <div class="flex-1 bg-gray-50 p-3 rounded-lg">
                      <div class="flex justify-between items-start">
                        <span class="text-sm font-medium">asdasd</span>
                        <span class="text-xs text-gray-500">asdasd</span>
                      </div>
                      <p class="text-sm mt-1">{{ $comment->content }}</p>
                    </div>
                  </div>
                  {{-- @empty --}}
                  <p class="text-sm text-gray-500 text-center py-2">halohalo</p>
                  {{-- @endforelse --}}
                </div>
              </div>
            </div>
