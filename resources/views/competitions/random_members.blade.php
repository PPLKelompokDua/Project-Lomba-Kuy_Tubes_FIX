    ...
    @if($randomUsers->count() > 0)
        ...
        <div class="text-center my-10 space-y-4">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                ...
                <a href="#" class="inline-flex items-center px-6 py-3 text-base font-medium rounded-full text-white bg-yellow-400 hover:bg-yellow-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 transform transition-all duration-200 hover:-translate-y-1">
