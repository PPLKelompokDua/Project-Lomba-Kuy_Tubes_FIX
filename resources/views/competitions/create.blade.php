        ...
        <div class="card-body">
            ...
            <form action="{{ route('competitions.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('registration_deadline') is-invalid @enderror" id="registration_deadline" name="registration_deadline" value="{{ old('registration_deadline') }}" required>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-text">Upload an image for your competition (max size: 2MB)</div>
                    @error('image')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="url" class="form-control @error('external_registration_link') is-invalid @enderror" id="external_registration_link" name="external_registration_link" value="{{ old('external_registration_link') }}" required>
