        ...
        <div class="col-lg-10">
            ...
            <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
                    ...
                    <div class="position-relative z-index-1">
                        <div class="d-flex align-items-center">
                            <div class="d-flex align-items-center justify-content-center rounded-circle me-3"
                                ...
                                <i class="bi bi-calendar-edit fa-lg text-white"></i>
                            </div>
                            <div>
                                <h4 class="text-white mb-0 fw-bold">Edit Milestone</h4>
                ...
                <div class="card-body p-lg-5 p-4">
                    <!-- Milestone Edit Form -->
                    <form action="{{ route('milestones.update', ['team' => $team->id, 'milestone' => $milestone->id]) }}" method="POST" class="milestone-form needs-validation" novalidate>
                        @csrf
                        @method('PUT')
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control border-start-0 ps-0 custom-input" id="title" name="title"
                                                   value="{{ old('title', $milestone->title) }}" style="border-color: #d1d5db;" placeholder="Enter milestone title..." required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control border-start-0 ps-0 custom-input custom-textarea" id="description" name="description" rows="4"
                                                      style="border-color: #d1d5db;" placeholder="Describe the milestone and targets to be achieved..." required>{{ old('description', $milestone->description) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="shadow-sm rounded-4 border p-4 mb-4" style="border-color: #e5e7eb !important;">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="date" class="form-control border-start-0 ps-0 custom-input" id="start_date" name="start_date"
                                                   value="{{ old('start_date', \Carbon\Carbon::parse($milestone->start_date)->format('Y-m-d')) }}" style="border-color: #d1d5db;" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="date" class="form-control border-start-0 ps-0 custom-input" id="end_date" name="end_date"
                                                   value="{{ old('end_date', \Carbon\Carbon::parse($milestone->end_date)->format('Y-m-d')) }}" style="border-color: #d1d5db;" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="status-selector">
                                            <div class="status-option">
                                                <input type="radio" id="status_not_started" name="status" value="Not Started" {{ $milestone->status == 'Not Started' ? 'checked' : '' }}>
                                            ...
                                            <div class="status-option">
                                                <input type="radio" id="status_in_progress" name="status" value="In Progress" {{ $milestone->status == 'In Progress' ? 'checked' : '' }}>
                                            ...
                                            <div class="status-option">
                                                <input type="radio" id="status_completed" name="status" value="Completed" {{ $milestone->status == 'Completed' ? 'checked' : '' }}>
                                ...
                                <div class="card border-0 bg-gradient-to-br mb-4 shadow-sm rounded-4 overflow-hidden"
                                    ...
                                    <div class="card-body p-4">
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <h5 class="card-title mb-0 fw-bold">Tips for Editing a Milestone</h5>
                                        </div>
                                        <ul class="ps-4 mb-0 small text-muted">
                                            <li class="mb-2">Ensure the title reflects current objectives</li>
                                            <li class="mb-2">Adjust the schedule if needed</li>
                                            <li class="mb-2">Update the description with any changes</li>
                                            <li>Save updates to reflect the latest status</li>
                                        </ul>
                                    </div>
                                </div>
