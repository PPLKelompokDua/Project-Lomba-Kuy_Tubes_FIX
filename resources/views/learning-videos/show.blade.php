...
@section('content')
<div class="min-h-screen rounded-[15px]">
    <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <!-- Hero Section with Video Info -->
        <div class="relative mb-6 overflow-hidden bg-gradient-to-r from-indigo-600 to-purple-700 rounded-2xl shadow-xl transform hover:scale-[1.01] transition-all duration-300">
            <!-- Decorative elements -->
        ...
        <div class="grid grid-cols-1 gap-6">
            <!-- Video Player -->
            <div>
                <div class="bg-white rounded-2xl shadow-xl overflow-hidden mb-6 transform hover:shadow-2xl transition-all duration-300">
                    <div class="p-0">
            ...
            <!-- About This Video -->
            <div>
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden mb-6 transform hover:shadow-xl transition-all duration-300">
                    <div class="relative overflow-hidden">
                        ...
                        <div class="p-6 relative">
                            ...
                            @if($video->description)
                                <div class="prose text-gray-700 mb-6 max-w-none break-words">
            ...
            <div>
                <div class="bg-white rounded-2xl shadow-xl overflow-hidden mb-6 border border-gray-100 transform hover:shadow-2xl transition-all duration-300">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 p-4">
                        ...
                        <a href="{{ route('learning-videos.show', $relatedVideo->id) }}" class="flex gap-4 p-4 hover:bg-indigo-50 transition rounded-lg group">
                            <div class="w-40 h-24 bg-gray-100 flex-shrink-0 relative rounded overflow-hidden shadow-sm">
                            ...
                            <div class="flex flex-col justify-center flex-1">
                                <div class="flex items-center text-xs mb-1 text-gray-500">
                                    <span class="bg-black bg-opacity-10 px-2 py-0.5 rounded text-[10px] uppercase tracking-wide">{{ $relatedVideo->category }}</span>
                                </div>
                                <h3 class="text-sm font-semibold text-gray-800 group-hover:text-indigo-700 line-clamp-2">{{ $relatedVideo->title }}</h3>
                                @if($relatedVideo->description)
                                    <p class="text-xs text-gray-500 line-clamp-2">{{ Str::limit($relatedVideo->description, 100) }}</p>
                                @endif
                            </div>
                        </a>
                        @endforeach
